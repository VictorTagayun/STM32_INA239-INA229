...
uint8_t INA239_send_packet[100], INA239_send_packet_mirror[100];
uint8_t INA239_recv_packet[100], INA239_recv_packet_mirror[100];
...
{
	INA239_send_packet_mirror[INA239_msg_lenght_cntr] = Address  + 1;
