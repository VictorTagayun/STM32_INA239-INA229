...
volatile uint8_t HAL_SPI_TxRxCpltCallback_finished = 1, HAL_SPI_TxRxCpltCallback_with_printf = 0, HAL_SPI_TxRxCpltCallback_repeat_previous = 0;
...
void SPI_DMA_TXRX(void)
{
	...
	HAL_SPI_TxRxCpltCallback_repeat_previous = 0;
...
void SPI_DMA_TXRX_repeat_previous(void)
{
	...
	HAL_SPI_TxRxCpltCallback_repeat_previous = 1;
...
void HAL_SPI_TxRxCpltCallback(SPI_HandleTypeDef *hspi)
{
	...
	if (HAL_SPI_TxRxCpltCallback_with_printf)
		HAL_SPI_TxRxCpltCallback_printf();

	if(!HAL_SPI_TxRxCpltCallback_repeat_previous)
		VT_INA229_ResetVars();

}

void HAL_SPI_TxRxCpltCallback_printf()
{
	GPIOC->BSRR = (1<<6); // Set
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	...
	case 0x65: // e
		...
		break;
	case 0x66: // f
		SPI_DMA_TXRX_repeat_previous_printf();
		break;
	default: // None
